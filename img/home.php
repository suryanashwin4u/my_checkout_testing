                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $student_email_id; ?></span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" onclick="loading_pages('my_profile.php')">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <marquee width="100%" direction="left" height="100px">
                            ...
                            <strong class="text-danger">*Due to lockdown, and Covid restrictions, we have shortage of tele-calling staff. Kindly prefer sending a Text message, WhatsApp message, or Mail, instead of calling. The message or mail queries shall be resolve on priority basis. While texting us, kindly don’t forget to mention registered email id. Thank you !</strong>
